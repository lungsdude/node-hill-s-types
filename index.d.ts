...
declare global {
    ...
    class Brick extends EventEmitter {
        ...
        rotation: import { EventEmitter } from "events"
        import { Socket, Server } from "net"
        import { SmartBuffer } from "../smart-buffer/typings/smartbuffer"
        ...
        declare interface GameEventListeners<T extends Player = Player>
        {
        ...
        declare interface ToolEventListeners<T extends Player = Player>
        {
            activated: [player: T],
            equipped: [player: T],
            unequipped: [player: T],
